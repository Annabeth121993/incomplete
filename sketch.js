var score = 0.
var bow , arrow,  back_ground, scene;
...
function setup() {
  ...
  scene.addImage(back_groundImage);
  scene.scale = 2.5
...
function redBalloon() {
  ...
  red.addImage("the_red_balloon",red_balloonImage);
  red.velocityX = 3 ;
  red.lifetime = 150;
  red.scale = 0.1   ;
...
function blueBalloon() {
  ...
  blue.addImage ("the_blue_balloon",blue_balloonImage);
  blue.velocityX = 3 ;
  blue.lifetime = 150;
  blue.scale = 0.1   ;
}
...
function greenBalloon() {
  ...
  green.addImage ("the_green_balloon",green_balloonImage);
  green.velocityX = 3 ;
  green.lifetime = 150;
  green.scale = 0.1   ;
}
